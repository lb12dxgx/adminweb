   ...
   <div class="seach">
    ...
    <div class="list">
      <el-table :data="list" highlight-current-row v-loading="listLoading" border style="width: 100%">
        ...
        <el-table-column prop="giftName" label="礼物名称"  width="150" > </el-table-column>
        <el-table-column prop="viewNum" label="查看数量" width="100"  > </el-table-column>
        <el-table-column prop="answerNum" label="回答数量" width="100" > </el-table-column>
        <el-table-column prop="dayNum" label="问题天数"  > </el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleView(row){
        this.$router.push({ path:'/main/system/sns/problemview', query:{problemId:row.problemId}});
      },
