<template>
  <div class="content">
    <el-tabs value="four"  @tab-click="handleClick">
   ...
   <div class="seach">
    ...
    <div class="list">
      <el-table :data="list" highlight-current-row v-loading="listLoading" border style="width: 100%">
       ...
       <el-table-column prop="refundDate" label="退款时间" width="100"> </el-table-column>
...
<script>
  import {getProblemOverAndRefundList} from '../../api/sns';
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
          ...
          NProgress.start();
          getProblemOverAndRefundList(params).then(data => {
