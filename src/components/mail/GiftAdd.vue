    ...
    data() {
      return {
        ...
        addFormRules: {
          ...
          picUrl:[
            { required: true, message: '请填大图地址', trigger: 'blur' }
          ],
          smailPicUrl:[
            { required: true, message: '请填小图地址', trigger: 'blur' }
          ],
          descUrl:[
            { required: true, message: '礼物介绍地址', trigger: 'blur' }
          ],
          state:[
